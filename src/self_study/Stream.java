...
public class Stream {
    public static void main(String[] args) {
        ...
        java.util.stream.Stream<String> stream1 = java.util.stream.Stream.of(new String[]{"a","b","c"});
        java.util.stream.Stream<String> stream2 = Arrays.stream(new String[]{"a","b","c"});
        java.util.stream.Stream<String> stream3 = Arrays.stream(new String[]{"a","b","c"},0,3);
        ...
        * 생성한 Stream 객체에서 요소들을 가공하기 위해서는 중간 연산이 필요하다. 가공하기 단계의 파라미터로는 앞서 설명하였던 함수형 인터페이스들이 사용되며, 여러 개의 중간 연산이 연결되도록 반환값으로 Stream을 반환한다.*/
        ...
        java.util.stream.Stream<String> stream5 =
                list.stream()
        ...
        java.util.stream.Stream<File> fileStream = java.util.stream.Stream.of(new File("Test1.java"),new File("Test2.java"),new File("Test3.java"));
        java.util.stream.Stream<String> fileNameStream = fileStream.map(File::getName);
        ...
        java.util.stream.Stream<String> stream6 = list1.stream()
                .sorted();

        java.util.stream.Stream<String> stream7 = list.stream()
        ...
        java.util.stream.Stream<String> stream8 = list.stream()
                .distinct();
